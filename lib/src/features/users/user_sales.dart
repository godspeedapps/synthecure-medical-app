...
class UserSalesOverview extends ConsumerWidget {
  const UserSalesOverview({super.key});
...
class _OverviewCardSpecial extends StatelessWidget {
  final String title;
  final IconData icon;
  final Color iconColor;
  final String mode;

  const _OverviewCardSpecial(
      {required this.title,
      required this.icon,
      required this.iconColor,
      required this.mode});
