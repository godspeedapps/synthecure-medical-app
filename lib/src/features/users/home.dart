...
import 'package:synthecure/src/features/users/user_sales.dart';
...
class RepHome extends ConsumerStatefulWidget {
  const RepHome({super.key});

  @override
  ConsumerState<RepHome> createState() =>
      _RepHomeState();
}

class _RepHomeState extends ConsumerState<RepHome> {
