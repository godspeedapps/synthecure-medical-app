...
final userAccountPageProvider =
    StateProvider<AppUser?>((ref) => null);
...
class AccountView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final model = ref.watch(userAccountPageProvider)!;

    ref.listen<AsyncValue>(
      userAccountControllerProvider,
      (_, state) =>
          state.showAlertDialogDeleteUser(context, model),
    );
                                ...
                                (context) =>
                                    CupertinoAlertDialog(
                                      title: Text(
                                          'Delete ${model.email}'),
                                      content: Text(
                                          "Are you sure you want to delete ${model.firstName}'s profile? All case sheet data will persist, but the user will lose their history"),
                                      actions: [
